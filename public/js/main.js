...
module.exports = {"prompts":[{"id":"mood","title":"Mood Prompt","type":"int","prompt":"Tell me your mood.","body":""},{"id":"book","title":"Book Prompt","type":"int","prompt":"Favorite Books","body":"Tell me two of your favorite books. Send it to me."},{"id":"flowers","title":"2Flowers","type":"nonint","prompt":"Pen flowers","body":"Make a bouquet of flowers with pens. Hand them to your partner."},{"id":"lemons","title":"Life Gives Lemons","type":"nonint","prompt":"Draw some lemons","body":"Draw them on a piece of paper. Give that drawing to somebody. Tell them, \"Life gave you lemons\" "},{"id":"spirit","title":"Spirit Animals","type":"nonint","prompt":"Spirit Animals","body":"Draw your spirit animal on a small piece of paper. Pass it to the person to the left of you."},{"id":"number","title":"Thoughtful Numbers","type":"nonint","prompt":"Think of a number","body":"Say it out loud."},{"id":"migrate","title":"Migration Station","type":"nonint","prompt":"Migrate","body":"Migrate to the middle of the room. Stay there until further notice."},{"id":"Phrase","title":"Phrase Craze","type":"nonint","prompt":"Favorite Phrase","body":"Write your favorite phrase on a piece of paper. Put it in the jar that's on the stage."},{"id":"Memory","title":"Memory","type":"int","prompt":"Memories","body":"Give me one sentence about your happiest memory."},{"id":"shake","title":"Shake Hands","type":"nonint","prompt":"Shake","body":"Shake hands with one of the presenters."},{"id":"light","title":"light","type":"nonint","prompt":"","body":"Turn off a light. Turn it back on."},{"id":"modern","title":"modern art","type":"int","prompt":"","body":"What do you think of modern art?"},{"id":"box","title":"Box","type":"int","prompt":"","body":"You open a box. What's in it?"},{"id":"nightmare","title":"nightmare","type":"int","prompt":"","body":"When was the last time you had a nightmare?"},{"id":"drum","title":"drum","type":"nonint","prompt":"","body":"Drum roll some pens."},{"id":"emotion","title":"emotion","type":"int","prompt":"[image here]","body":"What emotion does this image give you?"},{"id":"rumor","title":"rumor","type":"int","prompt":"","body":"Have you heard of the rumor?"},{"id":"stage","title":"stage","type":"nonint","prompt":"","body":"Walk across the stage to the center. Pose as your favorite sculpture."},{"id":"door","title":"door","type":"nonint","prompt":"","body":"Knock on a door."},{"id":"time","title":"time","type":"int","prompt":"","body":"Describe time in one sentence."},{"id":"pet","title":"pet","type":"int","prompt":"","body":"What is the last thing you said to your pet?"},{"id":"year","title":"year","type":"int","prompt":"","body":"What common phrase describes your year?"},{"id":"haiku","title":"haiku","type":"int","prompt":"Finish this Haiku:","body":"Autumn so fleeting. Ascending mental Reverb. ________."},{"id":"mind","title":"mind","type":"int","prompt":"","body":"What is never in your mind?"},{"id":"barter","title":"barter","type":"nonint","prompt":"","body":"Barter with somebody near you."},{"id":"giraffe","title":"giraffe","type":"nonint","prompt":"","body":"Discuss with anyone about the possibility of giraffes being too tall"},{"id":"portrait","title":"portrait","type":"nonint","prompt":"","body":"Get someone to draw your portrait."},{"id":"realize","title":"realize","type":"int","prompt":"","body":"What is your latest realization?"},{"id":"fear","title":"fear","type":"int","prompt":"","body":"Write an irrational fear."},{"id":"decade","title":"decade","type":"int","prompt":"","body":"Describe one   decade."}]};

/***/ }),

/***/ "./source/js/interactivePrompt.js":
/*!****************************************!*\
  !*** ./source/js/interactivePrompt.js ***!
  \****************************************/
/*! no static exports found */
...
function pageChecker(){
    ...
    for (var i = promptPages.length - 1; i >= 0; i--) {
        if(url.indexOf(promptPages[i]) > -1){
            ...
            js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.set('visited_'+promptPages[i], true);
        } else {
...
// The key here is to loop BACKWARDS, as each time an object is spliced, the array is reindexed and length becomes obsolete
        for (var i = promptPages.length - 1; i >= 0; i--) {
            if (js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.get("visited_"+promptPages[i])) {
...
function promptGenerator() {
    ...
    if (promptPages.length == 0) {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()("#loadingPrompt").text("All Prompts Have Been Finished!")
        jquery__WEBPACK_IMPORTED_MODULE_1___default()("#resetButton").removeClass('hidden');
    } else {
...
function resetCookies(){
    for (var i = 0; i < promptPages.length; i++) {
        js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.remove('visited_'+promptPages[i]);
    }
}
...
function changeBackgroundColor(randomColors){
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(".mainBody").css('background-color', randomColors[randColor]);
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _data_prompts_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../data/prompts.json */ "./source/data/prompts.json");
var _data_prompts_json__WEBPACK_IMPORTED_MODULE_0___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../data/prompts.json */ "./source/data/prompts.json", 1);
...
// $.getJSON( "prompts.json", function( jsonData ) {
  ...
  var promptData = _data_prompts_json__WEBPACK_IMPORTED_MODULE_0__.prompts;
...
/***/ 0:
/*!**********************************************************************************************************************************************!*\
  !*** multi ./source/js/main.js ./source/js/prompt.js ./source/js/interactivePrompt.js ./source/js/promptGenerator.js ./source/scss/app.scss ***!
  \**********************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! ./source/js/main.js */"./source/js/main.js");
__webpack_require__(/*! ./source/js/prompt.js */"./source/js/prompt.js");
__webpack_require__(/*! ./source/js/interactivePrompt.js */"./source/js/interactivePrompt.js");
