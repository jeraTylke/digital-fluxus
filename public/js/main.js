...
function pageChecker(){
    ...
    for (var i = promptPages.length - 1; i >= 0; i--) {
        if(url.indexOf(promptPages[i]) > -1){
            ...
            js_cookie__WEBPACK_IMPORTED_MODULE_1___default.a.set('visited_'+promptPages[i], true);
        } else {
...
// The key here is to loop BACKWARDS, as each time an object is spliced, the array is reindexed and length becomes obsolete
        for (var i = promptPages.length - 1; i >= 0; i--) {
            if (js_cookie__WEBPACK_IMPORTED_MODULE_1___default.a.get("visited_"+promptPages[i])) {
...
function promptGenerator() {
    ...
    if (promptPages.length == 0) {
        jquery__WEBPACK_IMPORTED_MODULE_2___default()("#loadingPrompt").text("All Prompts Have Been Finished!")
        jquery__WEBPACK_IMPORTED_MODULE_2___default()("#resetButton").removeClass('hidden');
    } else {
...
function resetCookies(){
    for (var i = 0; i < promptPages.length; i++) {
        js_cookie__WEBPACK_IMPORTED_MODULE_1___default.a.remove('visited_'+promptPages[i]);
    }
}
...
function changeBackgroundColor(randomColors){
    ...
    jquery__WEBPACK_IMPORTED_MODULE_2___default()(".mainBody").css('background-color', randomColors[randColor]);
}
...
/***/ 0:
/*!***************************************************************************************************************!*\
  !*** multi ./source/js/main.js ./source/js/prompt.js ./source/js/interactivePrompt.js ./source/scss/app.scss ***!
  \***************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
